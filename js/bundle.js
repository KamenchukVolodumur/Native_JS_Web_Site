...
function cards() {
    ...
    (0,_services__WEBPACK_IMPORTED_MODULE_0__.getResourse)('http://localhost:3000/menu')
       .then(data => {
    ...
    function bindPostDate(form) {
        form.addEventListener('submit', (e) => {
          ...
          `;
            ...
            (0,_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
                .then(data => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector, tabsContenntSelector, tabsParentSelctor, activeClass){
    const tabs = document.querySelectorAll(tabsSelector),
      tabsContent = document.querySelectorAll(tabsContenntSelector),
...
const getResourse = async (url) =>{
    const res = await fetch(url);
    if (!res.ok){
       throw new Error(`coudn't not fetch ${url}, status: ${res.status}`);
    }
    return await res.json();
 };
...
/* harmony import */ var _modules_deadline__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/deadline */ "./js/modules/deadline.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_deadline__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-08-08"');
    ...
    (0,_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])(modalTimerId, 'form');
